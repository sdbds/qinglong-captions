...
class MiniMaxCodeProvider(CloudVLMProvider):
    ...
    def can_handle(cls, args, mime: str) -> bool:
        ...
        2. 支持 image 和 video
        """
        return getattr(args, "minimax_code_api_key", "") != ""
    ...
    def attempt(self, media: MediaContext, prompts: PromptContext) -> CaptionResult:
        ...
        try:
            ...
            self.log(f"Failed to parse MiniMax Code JSON response: {e}", "yellow")
    ...
    def get_retry_config(self):
        ...
        cfg.on_exhausted = lambda e: (self.ctx.console.print(f"[yellow]MiniMax Code retries exhausted: {e}[/yellow]") or "")
        return cfg
