    ...
    def _render_basic_settings(self):
        ...
        with ui.card().classes(get_classes('card') + ' w-full q-pa-md'):
            ...
            self.dataset_path = create_path_selector(
                label=t('dataset_path'),
                selection_type='dir',
                placeholder=t('input_path_placeholder')
            )
            
            # 配对目录
            self.pair_dir = create_path_selector(
                label=t('pair_dir'),
                selection_type='dir',
                placeholder=t('pair_dir_hint')
            )
                ...
                with ui.card().classes(get_classes('card') + ' w-full q-pa-md'):
                    ...
                    if config.get('custom_model_input'):
                        ...
                        model_input = ui.input(
                            label=t('model_path'),
                            placeholder='输入你的 Endpoint Model ID',
                    ...
                    if config['supports_task']:
                        task_input = ui.input(
                            label=t('gemini_task'),
                            placeholder=t('gemini_task_placeholder')
                        )
